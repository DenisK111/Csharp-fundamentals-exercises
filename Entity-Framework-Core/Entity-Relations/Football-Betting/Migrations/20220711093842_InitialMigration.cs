...
namespace Football_Betting.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTime = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2022, 7, 11, 12, 38, 41, 947, DateTimeKind.Local).AddTicks(9144)),
                    HomeTeamBetRate = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    AwayTeamBetRate = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    DrawBetRate = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prediction = table.Column<string>(maxLength: 10, nullable: false),
                    DateTime = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2022, 7, 11, 12, 38, 41, 940, DateTimeKind.Local).AddTicks(3052)),
                    UserId = table.Column<int>(nullable: false),
                    GameId = table.Column<int>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GameId = table.Column<int>(nullable: false),
                    PlayerId = table.Column<int>(nullable: false),
                    ScoredGoals = table.Column<byte>(type: "tinyInt", nullable: false, defaultValue: (byte)0),
                    Assists = table.Column<byte>(type: "tinyInt", nullable: false, defaultValue: (byte)0),
